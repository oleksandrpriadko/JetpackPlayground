...
public class BallaratFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.button_to_melbourne).setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_ballaratFragment_to_melbourneFragment));

        view.findViewById(R.id.button_to_vic).setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_ballaratFragment_pop));
    }
}
